<template>
    <section class="why-section" id="sustainability">
        ...
        <div class="container why-inner">
            ...
            <div class="why-pillars">
                ...
                <div class="pillar">
                    <div class="pillar-icon"><svg viewBox="0 0 50 50" width="26" height="26">
                            <path d="M10 28C10 22 14 16 25 16C30 16 38 18 38 28C38 32 35 38 35 38H15C15 38 10 34 10 28Z"
                                fill="none" stroke="#C8A85A" stroke-width="2" />
...
.why-bg {
    position: absolute;
    inset: 0;
    background-image: url('../../public/img/whychoose.jpg');
